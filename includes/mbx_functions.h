...
/*   Updated: 2026/01/10 14:07:38 by rprieur          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			mbx_set_pixel(t_mbx *mbx, t_vec2i pos, mlx_color col);
void			mbx_set_pixel_xy(t_mbx *mbx, int x, int y, mlx_color col);
...
void			mbx_set_char(t_mbx *mbx,
					t_vec2i pos, char c, mlx_color col_override);
...
void			mbx_set_region_pixel(t_mbxregion *region,
					t_vec2i pos, mlx_color col);
void			mbx_set_region_pixel_xy(t_mbxregion *region,
					int x, int y, mlx_color col);
